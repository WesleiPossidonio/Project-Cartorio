  ...
  return (
    <div>
      <ContainerModal>
        ...
        <ContainerRequeriments>
          {RequerimentCompleted?.exigencia?.assinatura_do_advogado ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.campo_de_assinatura ===
            'Recebido' && (
              <TextListModal>
                Preencher todos os campos de assinatura;
              </TextListModal>
            )}
          {RequerimentCompleted?.exigencia?.declaracao_criminal ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.declaracao_de_desimpedimento ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.documento_inelegivel ===
            'Recebido' && (
              <TextListModal>
                Documento inelegível, solicitar um novo documento{' '}
              </TextListModal>
            )}
          {RequerimentCompleted?.exigencia?.dissolucao_ou_exticao ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.documentacao_de_identificacao ===
            'Recebido' && (
              <TextListModal>
                Apresentar cópia simples do documento de identificação
              </TextListModal>
            )}
          {RequerimentCompleted?.exigencia?.fundacoes === 'Recebido' && (
            <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.livro_rasao === 'Recebido' && (
            <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.reconhecimento_de_firma ===
            'Recebido' && (
              <TextListModal>
                presentar reconhecimento de firme no requerimento do DBE
              </TextListModal>
            )}
          {RequerimentCompleted?.exigencia?.requisitos_criacao_de_estatuto ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia
          ...
          {RequerimentCompleted?.exigencia?.requisitos_estatuto ===
            'Recebido' && (
              <TextListModal>
          ...
          {RequerimentCompleted?.exigencia?.retificacao_de_redacao ===
            'Recebido' && (
              <TextListModal>
