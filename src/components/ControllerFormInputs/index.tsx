  ...
  return (
    <ContainerControllerInput>
      <ContentInput>
        ...
        <ContainerCheckInput>
          <TextRegular weight="bold" size="s">
            Colher assinatura do advogado no ato apresentado para registro; (Lei
        ...
        <ContainerCheckInput>
          <TextRegular weight="bold" size="s">
            Apresentar declaração de desimpedimento (contratos e averbações de
        ...
        <ContainerCheckInput>
          <TextRegular weight="bold" size="s">
            Apresentar livro razão ou contábil anteriormente registrado; (CNCGJ
            Art. 960 § 1º) ?
          </TextRegular>
          <ContainerInput>
            <input
      ...
      <ContentInput>
        ...
        <ContainerCheckInput>
          <TextRegular weight="bold" size="s">
            o No caso de dissolução ou extinção apresentar o documento:
        ...
        <ContainerCheckInput>
          <TextRegular weight="bold" size="s">
            oNos atos referentes a fundações, exigir-se-á aprovação prévia do
