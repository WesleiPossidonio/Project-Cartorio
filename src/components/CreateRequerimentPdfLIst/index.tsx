  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {data &&
          data.exigencias &&
          data.exigencias.map((exigencia) => {
            return (
              <View key={exigencia.id} style={styles.main}>
                ...
                {exigencia.requisitos_estatuto === 'Pendente' && (
                  <Text style={styles.text}>
                    ...
                    Federal (Obs:para diretórios de partidos políticos); (CNCGJ
                    Art. 945)
                  </Text>
                )}

                {exigencia.declaracao_de_desimpedimento === 'Pendente' && (
                  <Text style={styles.text}>
                ...
                {exigencia.documentacao_de_identificacao === 'Pendente' && (
                  <Text style={styles.text}>
                ...
                {exigencia.requisitos_de_estatutos_fundadores ===
                  ...
                  <Text style={styles.text}>
                    ...
                    relação de documentos de fundadores; ( CNCGJ Art. 945 / Lei
                    6.015 no Art. 120 / Lei 10.406 Art. 46)
                  </Text>
                )}

                {exigencia.requisitos_criacao_de_estatuto === 'Pendente' && (
                  <Text style={styles.text}>
